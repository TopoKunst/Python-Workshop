...
# triangular wave sampler with give frequency and amplitude
...
def note(f, start, end, fade=.01):
    ...
    def sampler(t):
        ...
        if seconds < start:
            ...
            return 0
        # fade effect in the start and end to make the sound natural
...
# octave affects freq, and then further affects tone/pitch
def mario_at(octave):
    c = tri(octave * c_freq)
    e = tri(octave * e_freq)
    g = tri(octave * g_freq)
